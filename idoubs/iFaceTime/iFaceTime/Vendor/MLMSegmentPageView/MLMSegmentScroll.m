...
- (void)addViewCacheIndex:(NSInteger)index {
    ...
    if ([object isKindOfClass:[NSString class]]) {
        Class classs = NSClassFromString(object);
        if ([classs isSubclassOfClass:[UIViewController class]]) {//vc
            UIViewController *vc = [classs new];
            [self addVC:vc atIndex:index];
        } else if ([classs isSubclassOfClass:[UIView class]]){//view
            UIView *view = [classs new];
