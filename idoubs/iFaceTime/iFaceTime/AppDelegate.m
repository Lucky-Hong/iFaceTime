...
//  iFaceTime
//
//  Created by yesdgq on 2018/1/30.
...
//    [self initializeTabbar];
    ...
    IFTLoginVC *loginVC = DONG_INSTANT_VC_WITH_ID(@"Main", @"IFTLoginVC");
    IFTBaseNavigationController *nav = [[IFTBaseNavigationController alloc] initWithRootViewController:loginVC];
