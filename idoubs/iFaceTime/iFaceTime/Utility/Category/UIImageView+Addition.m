...
const char kRadius = '\0';
const char kRoundingCorners = '\0';
const char kIsRounding = '\0';
const char kHadAddObserver = '\0';
const char kProcessedImage = '\0';

const char kBorderWidth = '\0';
const char kBorderColor = '\0';
