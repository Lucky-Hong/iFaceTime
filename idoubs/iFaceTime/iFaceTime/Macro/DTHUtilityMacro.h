...
//  DTH Service App
//
//  Created by yesdgq on 2017/3/10.
//  Copyright © 2017年 yesdgq. All rights reserved.
//

#ifndef DTHUtilityMacro_h
#define DTHUtilityMacro_h
...
// 按钮点击事件1
#define DONG_RAC_BUTTON(button,expression) [[button rac_signalForControlEvents:UIControlEventTouchUpInside]\
subscribeNext:^(UIButton *btn) { expression ;}];

// 按钮点击事件2
#define DONG_RAC_COMMAND(expression) [[RACCommand alloc] initWithSignalBlock:^RACSignal *(id input) {\
expression; \
